...
public class MyArrayAdapter extends ArrayAdapter<DictionaryData> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView textViewRussianChars = (TextView) rowView.findViewById(R.id.textViewRussianChars);
        ...
        if (itemsArrayList.get(0)._id != -1) {
            ...
            textViewRussianChars.setText(itemsArrayList.get(position).getRussianCharsSpannable(searchKey));
        } else {
            //textViewJapaneseChars.setText("");
            textViewEnglishChars.setText("");
            textViewRussianChars.setText("");
        }
        ...
        rowView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (itemsArrayList.get(0)._id != -1) {
                    ...
                    i.putExtra("russianWords", itemsArrayList.get(position).getRussianChars(searchKey));
