...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/com.russiandictionary.app/databases/";

    private static String DB_NAME = "russiandict.db";
    ...
    // table name
    private static final String TABLE_DICTIONARY = "russiandict";
